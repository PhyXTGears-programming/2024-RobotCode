...
robot1::SpeakerShooterSubsystem::SpeakerShooterSubsystem(std::shared_ptr<cpptoml::table> table)
:   m_shootMotor1(
...
void robot1::SpeakerShooterSubsystem::Periodic() {
...
void robot1::SpeakerShooterSubsystem::Shoot() {
    SetShooterSpeed(
...
void robot1::SpeakerShooterSubsystem::SlowShoot() {
    SetShooterSpeed(
...
void robot1::SpeakerShooterSubsystem::ReverseShooter() {
    SetShooterSpeed(
...
void robot1::SpeakerShooterSubsystem::StopShooter() {
    m_shootMotor1.StopMotor();
}

bool robot1::SpeakerShooterSubsystem::IsNoteDetected() {
    m_isDetectFlagViewed = true;
    return m_isNoteDetected || !m_noteSensor.Get();
}

units::meter_t robot1::SpeakerShooterSubsystem::GetSpeakerDistance(){
    return units::meter_t(-1);
}

bool robot1::SpeakerShooterSubsystem::IsSpeakerNear() {
    return std::abs((m_config.distanceThreshold - GetSpeakerDistance()).value()) < 0.1;
}

rpm_t robot1::SpeakerShooterSubsystem::GetShooterSpeed(){
    return rpm_t(m_shootEncoder1.GetVelocity());
}

rpm_t robot1::SpeakerShooterSubsystem::GetFastSpeedThreshold() {
    return m_config.shoot.fast.speed;
}

rpm_t robot1::SpeakerShooterSubsystem::GetSlowSpeedThreshold() {
    return m_config.shoot.slow.speed;
}

void robot1::SpeakerShooterSubsystem::SetShooterSpeed(
    rpm_t speed,
