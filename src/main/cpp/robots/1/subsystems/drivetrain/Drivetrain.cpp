...
robot1::Drivetrain::Drivetrain(std::shared_ptr<cpptoml::table> table) {
    double turnP = 0.0;
    double turnI = 0.0;
    double turnD = 0.0;
...
void robot1::Drivetrain::Periodic() {
...
void robot1::Drivetrain::SetFieldOriented(bool isFieldOriented) {
    m_isFieldOriented = isFieldOriented;
}

void robot1::Drivetrain::ToggleFieldOriented() {
...
void robot1::Drivetrain::UpdateOdometry() {
    m_odometry->Update(
        frc::Rotation2d(GetHeading()),
        {
            m_frontLeft->GetPosition(),
...
void robot1::Drivetrain::ResetPosition(){
...
void robot1::Drivetrain::SetPosition(radian_t heading, frc::Pose2d toPose) {
    m_odometry->ResetPosition(
...
void robot1::Drivetrain::SetPose(frc::Pose2d toPose) {
    m_odometry->ResetPosition(
        frc::Rotation2d(GetHeading()),
        {
            m_frontLeft->GetPosition(),
...
Point robot1::Drivetrain::GetChassisPosition() {
