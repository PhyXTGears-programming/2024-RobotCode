...
robot1::SwerveModule::SwerveModule(
    int driveMotorCan,
    int turningMotorCan,
...
void robot1::SwerveModule::Periodic() {
    m_turningAbsPositionSignal.Refresh();
}

frc::SwerveModuleState robot1::SwerveModule::GetState() {
    return {
...
frc::SwerveModulePosition robot1::SwerveModule::GetPosition() {
    return {
...
void robot1::SwerveModule::SetDesiredState(
...
void robot1::SwerveModule::ResetTurnPosition() {
    m_turningEncoder.SetPosition(
        GetTurnAbsPosition().value()
    );
}

units::radian_t robot1::SwerveModule::GetTurnPosition() {
    return units::radian_t{ m_turningEncoder.GetPosition() };
}

units::radian_t robot1::SwerveModule::GetTurnAbsPosition() {
...
units::radian_t robot1::SwerveModule::GetTurnAbsPositionRaw() {
    return m_turningAbsPositionSignal.GetValue().convert<units::radian>();
}

void robot1::SwerveModule::UpdateDashboard() {
