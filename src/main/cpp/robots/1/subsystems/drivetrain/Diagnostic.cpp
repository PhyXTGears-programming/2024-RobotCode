...
#include "robots/1/subsystems/drivetrain/Diagnostic.h"
#include "util/math.h"
...
robot1::diagnostic::TestDrivetrain::TestDrivetrain(
...
void robot1::diagnostic::TestDrivetrain::Test01MeasureTurnConversionFactor() {
...
// and inertia.
void robot1::diagnostic::TestDrivetrain::Test02MeasureDriveConversionFactor() {
    static int speedFactor = 0;
...
void robot1::diagnostic::TestDrivetrain::Test03MeasureTurnAlignment() {
...
void robot1::diagnostic::TestDrivetrain::Test04TuneTurnPid() {
...
void robot1::diagnostic::TestDrivetrain::Test05TuneDrivePid() {
...
void robot1::diagnostic::TestDrivetrain::Test06MeasureDriveConversionFactor() {
