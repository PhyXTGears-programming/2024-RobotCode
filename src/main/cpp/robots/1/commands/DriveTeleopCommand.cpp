...
robot1::DriveTeleopCommand::DriveTeleopCommand(
...
void robot1::DriveTeleopCommand::Initialize() {}

void robot1::DriveTeleopCommand::Execute() {
...
void robot1::DriveTeleopCommand::End(bool interrupted) {
    // Stop the drive motors!
    m_drivetrain->Drive(0_mps, 0_mps, 0_rad_per_s, true, m_robotPeriod);
}

bool robot1::DriveTeleopCommand::IsFinished() {
