...
#include "robots/1/commands/DriveTeleopCommand.h"
 ...
 */
void robot1::Robot::RobotPeriodic() {
 ...
 */
void robot1::Robot::AutonomousInit() {
...
void robot1::Robot::AutonomousPeriodic() {
    m_drivetrain->UpdateOdometry(); 
}

void robot1::Robot::TeleopInit() {
    m_driveTeleopCommand.Schedule();
    m_openGate.Schedule();
    m_retractAmp.Schedule();
}

void robot1::Robot::TeleopPeriodic() {
    // Driver Controls
...
void robot1::Robot::TestInit() {}

void robot1::Robot::TestPeriodic() {}

void robot1::Robot::SimulationInit() {}

void robot1::Robot::SimulationPeriodic() {}
