...
robot2::DriveTeleopCommand::DriveTeleopCommand(
...
void robot2::DriveTeleopCommand::Initialize() {}

void robot2::DriveTeleopCommand::Execute() {
...
void robot2::DriveTeleopCommand::End(bool interrupted) {
    // Stop the drive motors!
    m_drivetrain->Drive(0_mps, 0_mps, 0_rad_per_s, true, m_robotPeriod);
}

bool robot2::DriveTeleopCommand::IsFinished() {
