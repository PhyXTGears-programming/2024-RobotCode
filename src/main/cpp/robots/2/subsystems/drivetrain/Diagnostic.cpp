...
#include "robots/2/subsystems/drivetrain/Diagnostic.h"
#include "util/math.h"
...
robot2::diagnostic::TestDrivetrain::TestDrivetrain(
...
void robot2::diagnostic::TestDrivetrain::Test01MeasureTurnConversionFactor() {
...
// and inertia.
void robot2::diagnostic::TestDrivetrain::Test02MeasureDriveConversionFactor() {
    static int speedFactor = 0;
...
void robot2::diagnostic::TestDrivetrain::Test03MeasureTurnAlignment() {
...
void robot2::diagnostic::TestDrivetrain::Test04TuneTurnPid() {
...
void robot2::diagnostic::TestDrivetrain::Test05TuneDrivePid() {
...
void robot2::diagnostic::TestDrivetrain::Test06MeasureDriveConversionFactor() {
