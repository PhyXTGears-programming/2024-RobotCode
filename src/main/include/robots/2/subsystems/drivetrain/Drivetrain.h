...
#include "robots/2/subsystems/drivetrain/DiagnosticDecl.h"
...
using robot2::constants::drive::k_numberOfSwerveModules;
    ...
    */
    class Drivetrain : public frc2::SubsystemBase {
        ...
        private:
            ...
            friend class robot2::diagnostic::TestDrivetrain;
    };
