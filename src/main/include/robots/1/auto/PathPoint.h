    ...
    class PathPoint {
        public:
            ...
            */
            ...
            /**
             * Returns the PathPointType of this PathPoint
             * 
             * @return The PathPointType of this PathPoint
            */
            PathPointType Type() const;

            /**
             * Returns the command that this PathPoint contains
             * 
             * @return The command of this PathPoint
            */
            frc2::Command * Command();

            /**
             * Returns if this PathPoint has a command to be run
             * 
             * @return Wheater this PathPoint has a command to be run
            */
